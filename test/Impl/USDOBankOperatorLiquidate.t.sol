...
contract USDOBankOperatorLiquidateTest is Test {
    ...
    function setUp() public {
        ...
        dodo = new SupportsDODO(address(USDC), address(ETH), address(jojoOracleETH));
    ...
    function testRepayAmountNotEnough() public {
        ...
        usdo.mint(50000e6);
        IERC20(usdo).transfer(address(usdoExchange), 50000e6);
        LiquidateCollateralRepayNotEnough flashLoanLiquidate =
        new LiquidateCollateralRepayNotEnough(address(usdoBank), address(usdoExchange), address(USDC), address(usdo), insurance);
    ...
    function testInsuranceAmountNotEnough() public {
        ...
        usdo.mint(50000e6);
        IERC20(usdo).transfer(address(usdoExchange), 50000e6);
        LiquidateCollateralInsuranceNotEnough flashLoanLiquidate =
        new LiquidateCollateralInsuranceNotEnough(address(usdoBank), address(usdoExchange), address(USDC), address(usdo), insurance);
    ...
    function testLiquidatedAmountNotEnough() public {
        ...
        usdo.mint(50000e6);
        IERC20(usdo).transfer(address(usdoExchange), 50000e6);
        LiquidateCollateralLiquidatedNotEnough flashLoanLiquidate =
        new LiquidateCollateralLiquidatedNotEnough(address(usdoBank), address(usdoExchange), address(USDC), address(usdo), insurance);
